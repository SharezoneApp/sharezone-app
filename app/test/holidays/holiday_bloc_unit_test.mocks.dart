...
class _FakeHolidayApiClient_0 extends _i1.SmartFake
  ...
  _FakeHolidayApiClient_0(Object parent, Invocation parentInvocation)
...
class _FakeKeyValueStore_2 extends _i1.SmartFake implements _i3.KeyValueStore {
  _FakeKeyValueStore_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockHolidayApi extends _i1.Mock implements _i2.HolidayApi {
  @override
  _i2.HolidayApiClient get apiClient =>
      (super.noSuchMethod(
  ...
  @override
  DateTime Function() get getCurrentTime =>
      (super.noSuchMethod(
            Invocation.getter(#getCurrentTime),
            returnValue:
                () => _FakeDateTime_1(this, Invocation.getter(#getCurrentTime)),
  ...
  _i4.Future<List<_i5.Holiday>> load(
    ...
    bool? returnPassedHolidays = false,
      ...
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i4.Future<List<_i5.Holiday>>.value(
              <_i5.Holiday>[],
            ),
          )
  ...
  void removePassedHolidays(List<_i5.Holiday>? holidayList) =>
      super.noSuchMethod(
        Invocation.method(#removePassedHolidays, [holidayList]),
        returnValueForMissingStub: null,
      );
}
...
class MockHolidayCache extends _i1.Mock implements _i7.HolidayCache {
  @override
  _i3.KeyValueStore get cache =>
      (super.noSuchMethod(
            Invocation.getter(#cache),
            returnValue: _FakeKeyValueStore_2(this, Invocation.getter(#cache)),
  ...
  @override
  Duration get maxValidDurationTillLastSaved =>
      (super.noSuchMethod(
  ...
  @override
  set getCurrentTime(_i7.SavingDateTimeFunction? value) => super.noSuchMethod(
    Invocation.setter(#getCurrentTime, value),
    returnValueForMissingStub: null,
  );

  @override
  _i7.CacheResponse? load(_i6.State? state) =>
      (super.noSuchMethod(
            Invocation.method(#load, [state]),
            returnValueForMissingStub: null,
          )
  ...
  List<_i5.Holiday> removePassedHolidays(List<_i5.Holiday>? holidays) =>
      (super.noSuchMethod(
            Invocation.method(#removePassedHolidays, [holidays]),
  ...
  @override
  _i4.Future<void> save(List<_i5.Holiday?>? holidays, _i6.State? state) =>
      (super.noSuchMethod(
            Invocation.method(#save, [holidays, state]),
  ...
  bool isCacheDataValid(
    ...
    Duration? maxDurationTillLastSaved,
      ...
      (super.noSuchMethod(
            Invocation.method(#isCacheDataValid, [
              cacheData,
