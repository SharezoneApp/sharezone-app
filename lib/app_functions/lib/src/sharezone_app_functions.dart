...
class SharezoneAppFunctions {
  ...
  Future<AppFunctionsResult<dynamic>> enterActivationCode({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'EnterActivationCode',
      parameters: {'activationCodeID': enteredActivationCode},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> joinWithGroupId({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'JoinWithGroupId',
      parameters: {'id': id, 'type': type, 'uId': uId},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> leave({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'Leave',
      parameters: {'id': id, 'type': type, 'memberID': memberID},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> groupEdit({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'GroupEdit',
      parameters: {'id': id, 'data': data, 'type': type},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> groupEditSettings({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'GroupEditSettings',
      parameters: {'id': id, 'settings': settings, 'type': type},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> groupCreate({
    ...
    return _appFunctions.callCloudFunction(
      ...
      parameters: {'memberID': memberID, 'id': id, 'data': data, 'type': type},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> userUpdate({
    ...
    return _appFunctions.callCloudFunction(
      ...
      parameters: {'userID': userID, 'userData': userData},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> memberUpdateRole({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'MemberUpdateRole',
      parameters: {'memberID': memberID, 'id': id, 'role': role, 'type': type},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> schoolClassAddCourse({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'SchoolClassAddCourse',
      parameters: {'schoolClassID': schoolClassID, 'courseID': courseID},
    );
  }
  ...
  Future<AppFunctionsResult<bool>> authenticateUserViaQrCodeId({
    ...
    return _appFunctions.callCloudFunction(
      functionName: 'QrCodeSignInAssignUID',
      parameters: {'qrID': qrId, 'uid': uid},
    );
  }
  ...
  Future<AppFunctionsResult<Map<String, dynamic>>> loadHolidays({
    ...
    return _appFunctions.callCloudFunction(
      ...
      parameters: {'stateCode': stateCode, 'year': year},
    );
  }
}
