  ...
  group('the table of contents', () {
    ...
    test(
      ...
      () {
        ...
        visibleSections.value = [
          _headingPosition('foo', itemLeadingEdge: 0.11, itemTrailingEdge: 0.2),
        ];
    ...
    test(
      ...
      () {
        ...
        visibleSections.value = [
          _headingPosition('foo', itemLeadingEdge: 0.1, itemTrailingEdge: 0.15),
        ];
    ...
    test(
      ...
      () {
        final sections = [_section('foo'), _section('bar')];

        final controller = createController(sections);

        // At bottom of the screen
        visibleSections.value = [
          _headingPosition('foo', itemLeadingEdge: 0.8, itemTrailingEdge: 0.85),
        ];

        // We scroll it to the top
        visibleSections.value = [
          _headingPosition('foo', itemLeadingEdge: 0.0, itemTrailingEdge: 0.05),
        ];
    ...
    test(
      ...
      () {
        ...
        // At bottom of the screen
        visibleSections.value = [
          _headingPosition('foo', itemLeadingEdge: 0, itemTrailingEdge: 0.05),
          ...
          _headingPosition('baz', itemLeadingEdge: 0.2, itemTrailingEdge: 0.25),
          _headingPosition('quz', itemLeadingEdge: 0.8, itemTrailingEdge: 1),
        ];
    ...
    test(
      ...
      () {
        final sections = [_section('foo'), _section('bar'), _section('baz')];
        ...
        // bottom
        visibleSections.value = [
          _headingPosition('bar', itemLeadingEdge: 0.8, itemTrailingEdge: 0.85),
        ];
    ...
    test(
      ...
      () {
        ...
        visibleSections.value = [
          _headingPosition('bar', itemLeadingEdge: 0, itemTrailingEdge: 0.1),
        ];

        // We the section down to the bottom again (we scroll up the page)
        visibleSections.value = [
          _headingPosition('bar', itemLeadingEdge: 0.95, itemTrailingEdge: 1),
        ];
    ...
    test('edge case: scrolling above first section', () {
      ...
      visibleSections.value = [
        _headingPosition('foo', itemLeadingEdge: 0.05, itemTrailingEdge: 0.15),
      ];

      // ... scroll up (section title is now at bottom of the viewport)
      visibleSections.value = [
        _headingPosition('foo', itemLeadingEdge: 0.95, itemTrailingEdge: 1),
      ];
    ...
    test(
      'edge case: scrolling below the last section (special case section)',
      () {
    ...
    test(
      ...
      () {
        ...
        visibleSections.value = [
          _headingPosition('foo', itemLeadingEdge: 0.1, itemTrailingEdge: 0.15),
          _headingPosition('bar', itemLeadingEdge: 0.2, itemTrailingEdge: 0.25),
        ];
    ...
    test(
      ...
      () {
        final sections = [_section('foo'), _section('bar'), _section('xyz')];
        ...
        visibleSections.value = [
          _headingPosition('bar', itemLeadingEdge: 0.5, itemTrailingEdge: 0.65),
          _headingPosition('xyz', itemLeadingEdge: 0.7, itemTrailingEdge: 0.75),
        ];
    ...
    test('A subsection is marked as currently read correctly', () {
      final sections = [
        _section('foo', subsections: [_section('quz'), _section('baz')]),
      ];
      ...
      visibleSections.value = [
        _headingPosition('foo', itemLeadingEdge: 0.9, itemTrailingEdge: 0.95),
      ];
      ...
      // bottom
      visibleSections.value = [
        _headingPosition('quz', itemLeadingEdge: 0.9, itemTrailingEdge: 0.95),
      ];

      // ... to the top
      visibleSections.value = [
        _headingPosition('quz', itemLeadingEdge: 0, itemTrailingEdge: 0.05),
      ];
    ...
    test(
      ...
      () {
        final sections = [_section('bar'), _section('baz')];
        ...
        visibleSections.value = [
          _headingPosition('bar', itemLeadingEdge: 0, itemTrailingEdge: 0.1),
          _headingPosition('baz', itemLeadingEdge: 0.6, itemTrailingEdge: 0.7),
    ...
    test('ignores unknwon heading', () {
      ...
      visibleSections.value = [
        _headingPosition('baz', itemLeadingEdge: 0, itemTrailingEdge: 0.1),
        _headingPosition(
          'unknown-section-id',
          itemLeadingEdge: 0.6,
    ...
    test(
      'regression test: ignores end section if it is not fully scrolled in',
      () {
        final sections = [_section('baz')];
    ...
    test(
      'regression test: scroll back up into only text area from end section',
      () {
        final sections = [_section('baz')];
...
class TestCurrentlyReadingController {
  ...
  DocumentSectionId? _getCurrentlyHighlighted() {
    final highlightedRes = _tableOfContentsController.documentSections!.where(
      (element) => element.shouldHighlight,
    );
    if (highlightedRes.isEmpty) {
      return null;
    }
    final highlighted = highlightedRes.single;
    final subHighlightedRes = highlighted.subsections.where(
      (element) => element.shouldHighlight,
    );
  ...
  TestCurrentlyReadingController(
    ...
    final listenable = ValueNotifier<IList<DocumentSectionHeadingPosition>>(
      IList(),
    );
    ...
    final privacyPolicy = privacyPolicyWith(
      tableOfContentSections: _tocSectionHeadings,
    );
