...
2. Add the new string to `lib/sharezone_localizations/l10n/app_en.arb`. Do not add metadata (e.g. `@your_new_string`) to the English file. Only add metadata to the German file.
