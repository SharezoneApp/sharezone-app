      ...
      children: [
        ...
        if (state == TakeIntoAccountState.disabledGradeTypeWithNoWeight)
          Padding(
            padding: const EdgeInsets.only(left: 58, bottom: 12),
            child: Text(
              'Der Notentyp hat aktuell eine Gewichtung von 0 für die Fachnote. Du kannst die Note weiterhin eintragen, aber sie wird nicht in den Schnitt deines Halbjahres einfließen. Du kannst die Gewichtung nach Speichern der Note anpassen, damit die Note in den Schnitt einfließt.',
              style: TextStyle(
                color: Theme.of(context).colorScheme.onSurface.withOpacity(0.5),
              ),
            ),
