...
void main() {
  group('grades', () {
    ...
    test(
      ...
      () {
        ...
        controller.changeGradeWeightsForSubject(
          ...
          weights: {const GradeId('grade1'): const Weight.percent(100)},
        );
    ...
    test(
      'subjects can have custom weights per grade type (e.g. presentation)',
      () {
        final controller = GradesTestController();
          ...
          subjects: [
            subjectWith(
              ...
              grades: [
                ...
                gradeWith(
                  value: 2.0,
                  type: const GradeTypeId('Mitarbeitsnote'),
                ),
    ...
    test(
      'Setting a grade weight to a negative number throws an $ArgumentError',
      () {
        final controller = GradesTestController();
        ...
        expect(
          () => controller.changeGradeWeightsForSubject(
            ...
            weights: {const GradeId('grade1'): const Weight.factor(-0.1)},
          ),
        ...
        final term = termWith(
          ...
          subjects: [
            subjectWith(
              ...
              grades: [gradeWith(type: GradeType.presentation.id)],
            ),
          ],
        );
        controller.createTerm(term);
    ...
    test(
      ...
      () {
        ...
        final term = termWith(
          id: const TermId('term1'),
          gradeTypeWeights: {GradeType.presentation.id: const Weight.factor(1)},
          subjects: [
            subjectWith(
              grades: [gradeWith(type: GradeType.presentation.id, value: 1.0)],
            ),
          ],
        );
        controller.createTerm(term);
    ...
    test(
      ...
      () {
        ...
        final term = termWith(
          id: const TermId('term1'),
          subjects: [
            subjectWith(id: const SubjectId('Mathe'), grades: [gradeWith()]),
          ],
        );
        controller.createTerm(term);
    ...
    test('term weights can be overridden by a subject', () {
      ...
      final term = termWith(
        ...
        subjects: [
          subjectWith(
            ...
            weightType: WeightType.inheritFromTerm,
            grades: [
              gradeWith(id: grade1Id, value: 3.0, type: presentation.id),
              gradeWith(id: grade2Id, value: 1.0, type: exam.id),
            ],
          ),
        ],
      );
      ...
      expect(
        subjectWithOverriddenGradeTypeWeights,
      ...
      expect(
        subjectWithOverriddenGradeWeights,
    ...
    test(
      ...
      () {
        ...
        expect(
          controller.term(const TermId('term1')).weightDisplayType,
    ...
    test(
      ...
      () {
        ...
        expect(
          controller.term(const TermId('term2')).weightDisplayType,
          WeightDisplayType.factor,
        );
      },
    );
      ...
      final term = termWith(
        ...
        subjects: [
          subjectWith(
            ...
            name: 'Deutsch',
            grades: [
              gradeWith(value: 3.0, type: GradeType.vocabularyTest.id),
              gradeWith(value: 1.0, type: GradeType.other.id),
            ],
          ),
        ],
      );
        ...
        final term = termWith(
          ...
          subjects: [
            subjectWith(
              ...
              grades: [
                gradeWith(value: 4.0, type: GradeType.writtenExam.id),
                gradeWith(value: 2.0, type: GradeType.vocabularyTest.id),
              ],
            ),
          ],
        );
    ...
    test('Its possible that no terms are active', () {
      ...
      expect(
        controller.terms,
        everyElement(
          predicate<TermResult>(
            (p0) => p0.isActiveTerm == false,
            'is not active',
          ),
        ),
      );
    ...
    test(
      ...
      () {
        ...
        expect(
          controller.term(term.id).gradingSystem,
    ...
    test(
      'Deleting a term will delete all grades inside it, but no subjects',
      () {
        final controller = GradesTestController();
    ...
    test('Deleting an unknown term will throw an ArgumentError', () {
      ...
      expect(
        () => controller.deleteTerm(const TermId('foo')),
        throwsA(isA<ArgumentError>()),
      );
    });
    ...
    test('A grade can be deleted', () {
      ...
      final term = termWith(
        subjects: [
          subjectWith(
            id: const SubjectId('Philosophie'),
            grades: [
              gradeWith(id: const GradeId('grade1'), value: 4.0),
              gradeWith(id: const GradeId('grade2'), value: 4.5),
            ],
          ),
        ],
      );
      ...
      expect(
        controller.term(term.id).subject(const SubjectId('Philosophie')).grades,
        hasLength(1),
      );
      ...
      () {
        ...
        expect(
          () => controller.addGrade(
            termId: term.id,
            subjectId: const SubjectId('Philosophie'),
            value: gradeWith(id: const GradeId('grade1'), value: 4.0),
          ),
    ...
    test(
      ...
      () {
        ...
        expect(
          () => controller.deleteGrade(gradeId: const GradeId('unknown')),
    ...
    () {
      ...
      expect(
        controller
            ...
            .map((sub) => sub.id)
            .toList(),
        [const SubjectId('Deutsch'), const SubjectId('Sport')],
      );
    },
  );
}
