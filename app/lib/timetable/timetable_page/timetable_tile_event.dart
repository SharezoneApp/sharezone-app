    ...
    return Padding(
      ...
      child: Material(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
            color: groupInfo?.design.color ?? Colors.grey,
            width: 1.5,
          ),
        ),
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                _EventTitle(title: event.title, color: groupInfo?.design.color),
                GroupName(
                ...
                if (event.place != null && event.place != "")
                  Room(room: event.place!, color: groupInfo?.design.color),
              ],
            ),
          ),
        ),
...
class _EventTitle extends StatelessWidget {
  const _EventTitle({required this.title, required this.color});
