...
class CourseCardRedesign extends StatelessWidget {
  ...
  void _logCourseDeleteViaCourseCardLongPress(Analytics analytics) {
    analytics.log(
      NamedAnalyticsEvent(name: "course_delete_via_card_long_press"),
    );
  }

  void _logCourseLeaveViaCourseCardLongPress(Analytics analytics) {
    analytics.log(
      NamedAnalyticsEvent(name: "course_leave_via_card_long_press"),
    );
  }
      ...
      builder: (context, constrains) {
        ...
        return SizedBox(
          ...
          child: CustomCard(
            ...
            onTap:
                () => openCourseDetailsPageAndShowConfirmationIfSuccessful(
                  context,
                  course,
                ),
            child: Column(
...
class SchoolClassVariantCourseTile extends StatelessWidget {
  ...
  void _logCourseJoinViaCourseButton(Analytics analytics) {
    analytics.log(
      NamedAnalyticsEvent(name: "course_join_via_school_class_button"),
    );
  }
              ...
              courseFromOwn == null
                  ? MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      final joinCourseFunction = courseGateway.joinCourse(
                        course.id,
                      );
                      showAppFunctionStateDialog(context, joinCourseFunction);
                    },
                  ...
                  : null,
          onLongPress: () => onLongPress(context, isMember, isAdmin ?? false),
        );
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Hero(
      ...
      child: CircleAvatar(
        ...
        child: Text(abbreviation ?? "-", style: TextStyle(color: color)),
      ),
    );
  }
}
