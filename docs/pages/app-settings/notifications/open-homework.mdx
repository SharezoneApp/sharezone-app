...
<Callout type="warning">
  Die Funktion, die Uhrzeit für die Benachrichtigungen festgelegen zu können, ist nur mit Sharezone Plus verfügbar!
  Ohne Sharezone Plus kannst du die Benachrichtigungen nur aktivieren oder deaktivieren.
</Callout>
